import { unitType } from "../pages/Game";

const metaDataButtons: unitType[] = [
  {
    svgIcon: (
      <svg
        id="Layer_1"
...
const mobileButtons: unitType[] = [
  {
    link: "https://www.linkedin.com/in/prajwal-dahat-04845a252/",
    svgIcon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
  ...
  {
    link: "https://github.com/prajwal-dahat0810",
    svgIcon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 20 20"
...
export const Footer = () => {
  return (
    <div className="w-full   my-4 py-0.5  flex flex-row flex-wrap justify-between px-3 items-center max-sm:gap-1 gap-10">
      <div className="flex text-[#636668] flex-row gap-4 flex-wrap">
        {mobileButtons.map((element, index) => {
          return (
            <div
              onClick={() => {
              ...
              key={index}
            >
              <div>{element.svgIcon}</div>
              <div className="text-[10px] font-[400] tracking-wider">
                {element.name}
              </div>
            </div>
          );
      ...
      <div className="flex text-[#636668] flex-row gap-4 flex-wrap">
        {metaDataButtons.map((element, index) => {
          if (index < 2)
            return (
              <div
                className="flex  cursor-pointer items-center justify-center gap-1"
